...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener, ConnectivityReceiver.ConnectivityReceiverListener {
...
// Checking for user session
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_request_sms:
                hud = KProgressHUD.create(Main2Activity.this)
    ...
    private void validateForm() {
        ...
        if (isValidPhoneNumber(mobile)) {
            ...
            Toasty.error(Main2Activity.this, "Please enter valid mobile number", Toast.LENGTH_SHORT, true).show();
        }
    }
    /**
    ...
    private void StartFirebaseLogin() {
        ...
        mCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
              //  Toast.makeText(Main2Activity.this,"verification completed",Toast.LENGTH_SHORT).show();
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toasty.error(Main2Activity.this, "verification failed"+e.getMessage(), Toast.LENGTH_SHORT, true).show();
            }
            @Override
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                //Toast.makeText(Main2Activity.this,"Code sent", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toasty.error(Main2Activity.this, "Incorrect OTP", Toast.LENGTH_SHORT, true).show();
                        }
                    }
                });
    }
