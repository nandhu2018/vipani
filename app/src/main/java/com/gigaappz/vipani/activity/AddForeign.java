...
public class AddForeign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_foreign_values);
        ...
        arrayAdapter = new ArrayAdapter<String>(AddForeign.this, android.R.layout.select_dialog_singlechoice);
        ...
        type.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builderSingle = new AlertDialog.Builder(AddForeign.this);
    ...
    public void listalert(){
        ...
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddForeign.this, android.R.layout.select_dialog_singlechoice);
            ...
            public void onResponse(JSONObject response) {
                ...
                builderInner.show();*/
                   ...
                   // progressBar.setVisibility(View.GONE);
                    Toast.makeText(AddForeign.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    public void addDomestic(final String token, final String title, final String sub, final String price,final String remarks) {
        ...
        String urlJsonObj = "http://tradewatch.xyz/api/updateIntPrice.php";
        JSONObject obj = new JSONObject();
        try {
            obj.put("auth", token);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (response.getString("responseStatus").equalsIgnoreCase("true")){
                        ...
                        Toasty.success(AddForeign.this, "Foreign value updated", Toast.LENGTH_SHORT, true).show();
                        startActivity(new Intent(AddForeign.this,NewMarketActivity.class));
                        finish();
                    }else {
                        Toast.makeText(AddForeign.this, ""+response.getString("responseMessage"), Toast.LENGTH_SHORT).show();
                    }

                } catch (JSONException e) {
                    Toasty.error(AddForeign.this, "Foreign value updation failed", Toast.LENGTH_SHORT, true).show();
                    // progressBar.setVisibility(View.GONE);
                }
